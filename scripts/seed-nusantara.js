...
const BAHAN = [
  ...
  ['Lontong', 'Karbohidrat'], ['Ketupat', 'Karbohidrat'], ['Tepung Sagu', 'Karbohidrat'],
  ['Tepung Beras', 'Karbohidrat'], ['Tepung Terigu', 'Karbohidrat'],
  ...
  ['Kacang Hijau', 'Protein'], ['Oncom', 'Protein'],
  ['Kelapa', 'Buah'], ['Pisang', 'Buah'], ['Mangga', 'Buah'], ['Jeruk', 'Buah'],
  ...
  ['Taoge', 'Sayuran'], ['Timun', 'Sayuran'], ['Sawi', 'Sayuran'], ['Daun Singkong', 'Sayuran'],
  ['Genjer', 'Sayuran'], ['Pepaya Muda', 'Sayuran'], ['Labu Kuning', 'Sayuran'],
  ['Jengkol', 'Sayuran'], ['Petai', 'Sayuran'],
  ['Bawang Merah', 'Bumbu Dasar'], ['Bawang Putih', 'Bumbu Dasar'], ['Cabai', 'Bumbu Dasar'], ['Cabai Rawit', 'Bumbu Dasar'],
  ['Kemiri', 'Bumbu Dasar'], ['Kemangi', 'Rempah'],
  ['Jahe', 'Rempah'], ['Kencur', 'Rempah'], ['Lengkuas', 'Rempah'], ['Kunyit', 'Rempah'],
  ['Ketumbar', 'Rempah'], ['Jintan', 'Rempah'], ['Daun Salam', 'Rempah'], ['Daun Jeruk', 'Rempah'],
  ['Serai', 'Rempah'], ['Kayu Manis', 'Rempah'], ['Cengkeh', 'Rempah'], ['Pala', 'Rempah'],
  ['Kapulaga', 'Rempah'], ['Merica', 'Rempah'], ['Kluwak', 'Rempah'],
  ['Santan', 'Bahan Cair'], ['Minyak Goreng', 'Bahan Cair'],
  ['Terasi', 'Penyedap'], ['Asam Jawa', 'Penyedap'], ['Ebi', 'Penyedap'],
  ['Garam', 'Penyedap'], ['Gula', 'Penyedap'], ['Gula Merah', 'Penyedap'], ['Kecap Manis', 'Penyedap'],
  ['Penyedap', 'Penyedap'], ['Kaldu Ayam', 'Penyedap'],
  ['Kerupuk', 'Pelengkap'], ['Kacang Tanah', 'Pelengkap'],
]
