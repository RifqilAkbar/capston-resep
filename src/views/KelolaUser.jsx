...
export default function KelolaUser({ token }) {
          ...
          users.map((u) => (
            <div key={u.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm p-5">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <span className={`text-[10px] px-2.5 py-1 rounded-full font-bold capitalize ${u.role === 'admin' ? 'bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300' : 'bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300'}`}>
                  {u.role}
                </span>
